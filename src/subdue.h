...
typedef struct 
{
   ...
   BOOLEAN used;   // flag for marking vertex used at various times
                   //   used flag assumed FALSE, so always reset when done
   ULONG TimesAddedToInstanceList;
} Vertex;
...
typedef struct _instance
{
   ...
   Vertex *verticesArray;   // array of graph vertices
   Edge   *edgesArray;      // array of graph edges
...
InstanceList *ExtendInstances(InstanceList *, Graph *, BOOLEAN);
...
BOOLEAN GraphMatch(Graph *, Graph *, LabelList *, double, double *,
                   VertexMap *);
BOOLEAN GraphMatch2(Graph *, Instance *, LabelList *, double, double *,
                   VertexMap *);
double InexactGraphMatch(Graph *, Graph *, LabelList *, double, VertexMap *);
double InexactGraphMatch2(Instance *, Graph *, LabelList *, double, VertexMap *);
double InexactGraphMatch3(Graph *, Instance *, LabelList *, double, VertexMap *);
void OrderVerticesByDegree(Graph *, ULONG *);
void OrderVerticesByDegree2(Instance *, ULONG *);
ULONG MaximumNodes(ULONG);
double DeletedEdgesCost(Graph *, Graph *, ULONG, ULONG, ULONG *, LabelList *);
double DeletedEdgesCost2(Instance *, Graph *, ULONG, ULONG, ULONG *, LabelList *);
double InsertedEdgesCost(Graph *, ULONG, ULONG *);
double InsertedEdgesCost2(Instance *, ULONG, ULONG *);
double InsertedVerticesCost(Graph *, ULONG *);
double InsertedVerticesCost2(Instance *, ULONG *);
...
void InstanceListInsert2(Instance *, InstanceList *, BOOLEAN, BOOLEAN);
...
BOOLEAN NewEdgeMatch2(Graph *, Instance *, Instance *, Instance *, 
                     Parameters *, double, double *);
